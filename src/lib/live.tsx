...
const SCRIPT: ScriptedEvent[] = [
  ...
  { tool: "issue_refund", agent: "assistant", outcome: "blocked", detail: "৳3,890 is over your ৳3,000 limit · sent to you", latencyMs: 7, policy: "G-2" },
  ...
  { tool: "issue_refund", agent: "manager", outcome: "approved", detail: "৳2,450 refunded after you approved it", latencyMs: 880, policy: "G-2" },
